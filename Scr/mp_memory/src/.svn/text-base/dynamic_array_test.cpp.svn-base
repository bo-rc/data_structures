...
int main()
{
    // std::cout << "test_empty_array()" << std::endl;
    test_empty_array();
    // std::cout << "test_sized_array()" << std::endl;
    test_sized_array();
    // std::cout << "test_copy_construction()" << std::endl;
    test_copy_construction();
    // std::cout << "test_move_construction()" << std::endl;
    ...
    test_swap();
    // std::cout << "test_resize_smaller()" << std::endl;
    test_resize_smaller();
    // std::cout << "test_resize_larger()" << std::endl;
    test_resize_larger();
    return 0;
}
