...
class binary_tree
{
  ...
  public:
    ...
    void printPaths(node* subRoot, std::vector<T>&) const;
    ...
    void sumDistUtil(node* subRoot, int& counter) const;
  ...
  private:
    ...
    /**
     * Private helper function for sumDistUtil();
     */
    int get_depth(node* subRoot, T data, int depth) const;

    /**
     * Private helper function for isOrdered()
     */
    bool isOrderedUtil(node* subRoot, T min, T max) const;

//    /**
//     * Private helper function for isOrderedUtil()
//     */
//    std::pair<T, T> tree_limits(node* subRoot) const;

//    /**
//     * Private helper function for tree_limits()
//     */
//    void traverse_and_save(node* subRoot, std::vector<T>& cont) const;
